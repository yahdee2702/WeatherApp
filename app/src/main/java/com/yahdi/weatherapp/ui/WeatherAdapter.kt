...
import com.yahdi.weatherapp.BuildConfig
import com.yahdi.weatherapp.R
import com.yahdi.weatherapp.data.response.ListItem
import com.yahdi.weatherapp.databinding.RowItemWeatherBinding
import com.yahdi.weatherapp.utils.HelperFunctions.formatDegree
import com.yahdi.weatherapp.utils.iconSizeWeather2x
...
class WeatherAdapter : RecyclerView.Adapter<WeatherAdapter.MyViewHolder>() {
    ...
    inner class MyViewHolder(val binding: RowItemWeatherBinding) :
...
//        Log.d("Data", listForecast[position].toString())
