...
import com.yahdi.weatherapp.databinding.ActivityMainBinding
import com.yahdi.weatherapp.utils.HelperFunctions.formatDegree
import com.yahdi.weatherapp.utils.LOCATION_PERMISSION_REQ_CODE
import com.yahdi.weatherapp.utils.iconSizeWeather4x
import java.util.*
...
class MainActivity : AppCompatActivity() {
    ...
    private fun getWeatherByCurrentLocation() {
        ...
        viewModel.getForecastWeatherByCurrentLocation().observe(this@MainActivity) {
            setupView(null, it)
            isLoading = false
            loadingStateView()
        }
